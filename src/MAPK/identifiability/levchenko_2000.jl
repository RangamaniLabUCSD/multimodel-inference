...
ode = @ODEmodel(
    ...
    x6'(t) = -(a3*x4(t)*x6(t)) + (d3*x7(t)) + (k4*x9(t)) + (kOff1*(x21(t) + x25(t) + x28(t))) - (kOn1*x6(t)*(x20(t) + x23(t) + x24(t))),
    ...
    x13'(t) = -(a7*x11(t)*x13(t)) + (d7*x14(t)) + (k8*x18(t)) + (kOff2*(x23(t) + x25(t) + x26(t))) - (kOn2*x13(t)*(x20(t) + x21(t) + x22(t))),
    ...
    x20'(t) = -(kOn1*x20(t)*x6(t)) - (kOn2*x20(t)*x13(t)) + (kOff1*x21(t)) + (kOff2*x23(t)) + (kOff3*x22(t)) + (kOff4*x24(t)),
    x21'(t) = (kOn1*x20(t)*x6(t)) + (kOff2*x25(t)) + (kOff4*x28(t)) - (kOff1*x21(t)) - (kOn2*x21(t)*x13(t)) - (k5*x21(t)*x4(t)),
    x22'(t) = -(kOn2*x22(t)*x13(t)) + (kOff2*x26(t)) - (kOff3*x22(t)) + (kOff4*x27(t)) + (k5*x21(t)*x4(t)),
    x23'(t) = (kOff1*x25(t)) + (kOn2*x20(t)*x13(t)) + (kOff3*x26(t)) - (kOff2*x23(t)) - (kOn1*x23(t)*x6(t)),
