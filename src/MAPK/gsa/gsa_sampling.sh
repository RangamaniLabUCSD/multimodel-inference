...
# Shin 2014
XLA_PYTHON_CLIENT_PREALLOCATE=false python gsa_sample.py shin_2014 -analyze_params kc47,kc43,kd39,kc45,ERK_tot,ki39,kc41 -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 540 -input_state EGF -input 1e-4 --full_trajectory -lower 1e-2 -upper 1e2

# Ryu 2015
XLA_PYTHON_CLIENT_PREALLOCATE=false python gsa_sample.py ryu_2015 -analyze_params D2,T_dusp,K_dusp,K2,dusp_ind -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 540 -input_state EGF -input 0.6048 --full_trajectory -lower 1e-2 -upper 1e2

# Kochańczyk 2017
XLA_PYTHON_CLIENT_PREALLOCATE=false python gsa_sample.py kochanczyk_2017 -analyze_params k3,q1,q3,q2,u3,d1,q6,u2b,u1a,d2,u2a,q5,u1b,q4 -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 3600 -input_state EGF -input 604.8 --full_trajectory -lower 1e-2 -upper 1e2
