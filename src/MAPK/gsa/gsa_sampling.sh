...
# Huang Ferrell 1996
python gsa_sample.py huang_ferrell_1996 -analyze_params MKK_tot,a3,k7,a4,d3,d10,d2,a2,d6,a8,a1,E2_tot,a7,a9,k5,a6,d1,d9,d5,k8,d8,k4,k6,k9,k3,d7,a10,MAPK_tot,k2,d4,a5,MKKK_tot,k10,MKKPase_tot,k1 -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 3000 -input_param E1_tot --full_trajectory -lower 1e-2 -upper 1e2

# Kholodenko 2000
python gsa_sample.py kholodenko_2000 -analyze_params K8,v10,v9,K7,K9,KI,MAPK_total,K10 -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 2400 -input_state Input --full_trajectory -ERK_state_indices -1 -lower 1e-2 -upper 1e2

# Birghtman and Fell 2000
# python gsa_sample.py brightman_fell_2000 -analyze_params kn14,K_24,kn16,V_26,kn1,k3,V_24,kn12,k15,k_13,kn7,kn11,K_25,k2_4,K_26,k17,K_23,DT -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 360 -input_state L -input 60221 --full_trajectory -lower 1e-2 -upper 1e2
...
# Hatakeyama 2003
python gsa_sample.py hatakeyama_2003 -analyze_params k21,k20,kb29,kf9,kb24,kb3,kb23,kf25,kb1,kb2,kf24,kb7,kf8,k19,kf34,k22,kb5,kf6,kf3,kb6 -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 3600 -input_state HRG --full_trajectory -ERK_state_indices 32 -lower 1e-2 -upper 1e2
...
# Orton 2009
python gsa_sample.py orton_2009 -analyze_params km_Erk_Activation,k1_C3G_Deactivation,km_Erk_Deactivation,k1_Akt_Deactivation,k1_P90Rsk_Deactivation,k1_PI3K_Deactivation,k1_Sos_Deactivation -n_samples 256 -savedir ../../../results/MAPK/gsa/ -max_time 720 -input_state EGF -input 60221 --full_trajectory -lower 1e-2 -upper 1e2
